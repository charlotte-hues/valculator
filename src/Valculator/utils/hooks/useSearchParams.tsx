...
export const useSearchParams: () =>  [searchParams: {[k: string]: string}, handleSearchParams: (newSearchParams: {[key: string]: string}) => void] = () => {
    const [params, setParams] = useState<{[k: string]: string}>(Object.fromEntries([...new URLSearchParams(window.location.search)]))
